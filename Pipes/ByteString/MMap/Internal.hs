...
--
module Pipes.ByteString.MMap.Internal (
...
foreign import ccall unsafe "hs_pipes_bytestring_mmap.h hs_pipes_bytestring_mmap"
    c_mmap   :: CSize -> CInt -> IO (Ptr Word8)

foreign import ccall unsafe "hs_pipes_bytestring_mmap.h munmap"
    c_munmap :: Ptr Word8 -> CSize -> IO CInt
